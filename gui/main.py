...
if __name__ == "__main__":
    ...
    def draw_frame(i):
        drawing = Drawing(app, width=1920, height=360)
        drawing.rectangle(60, -175 + i, 1920, i + 1, color=COLORS["blue"], outline=False)
        drawing.text(20, -165 + i, "1", color="#ffffff", font="Helvetica", size="36")
        drawing.text(85, -165 + i, "Blue Line #118 to", color="#ffffff", font="Helvetica", size="36")
        drawing.text(80, -135 + i, "O'Hare", color="#ffffff", font="Helvetica", size="130")
        drawing.text(980, -170 + i, "Due", color="#ffffff", font="Helvetica Bold", size="140")
        drawing.image(505, -120 + i, "gui/airplane.gif", 110, 110)
        app.display()
        sleep(.005)
        drawing.destroy()
            
#    drawing.rectangle(60, 184, 1920, 360, color=COLORS["grey"], outline=False)
#    drawing.text(20, 194, "2", color="#ffffff", font="Helvetica", size="36")
#    drawing.text(85, 194, "#72 Bus Eastbound to", color="#ffffff", font="Helvetica", size="36")
#    drawing.text(80, 224, "Clark", color="#ffffff", font="Helvetica", size="130")
#    drawing.text(920, 189, "7", color="#ffffff", font="Helvetica Bold", size="140")
#    drawing.text(1022, 192, "min", color="#ffffff", font="Helvetica", size="140")
